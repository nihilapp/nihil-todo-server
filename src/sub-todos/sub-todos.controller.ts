...
export class SubTodosController {
  ...
  async getTodos(): Promise<SubTodoEntity[]> {
  ...
  async getTodoById(@Param('id') id: number): Promise<SubTodoEntity> {
  ...
  async getTodoByUserId(@Param('userId') userId: number): Promise<SubTodoEntity[]> {
  ...
  async createTodo(@Body() createTodoDto: CreateSubTodoDTO): Promise<SubTodoEntity> {
